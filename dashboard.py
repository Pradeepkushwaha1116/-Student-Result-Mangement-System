...
class RMS:
    def __init__(self,root):
        ...
        # ===footer====
        footer=Label(self.root,text="SRMS - Student Result Managment System\nContact us for any Technical Issue:9653788774",padx=10,compound=LEFT,image=self.logo_dash,font=("goudy old style",20,"bold"),bg="#262626",fg="white").pack(side=BOTTOM,fill=X)
